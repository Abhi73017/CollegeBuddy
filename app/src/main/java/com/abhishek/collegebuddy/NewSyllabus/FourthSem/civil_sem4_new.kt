package com.abhishek.collegebuddy.NewSyllabus.FourthSem
...
import kotlinx.android.synthetic.main.activity_civil_sem4_new.*


class civil_sem4_new : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem4_new)
