package com.abhishek.collegebuddy.OldSyllabus.FifthSem
...
import kotlinx.android.synthetic.main.activity_civil_sem5_old.*

class civil_sem5_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem5_old)
