package com.abhishek.collegebuddy.OldSyllabus.SecondSem
...
import kotlinx.android.synthetic.main.activity_civil_sem2_old.*

class civil_sem2_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem2_old)
