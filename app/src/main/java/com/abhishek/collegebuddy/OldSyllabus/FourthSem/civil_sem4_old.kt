package com.abhishek.collegebuddy.OldSyllabus.FourthSem
...
import kotlinx.android.synthetic.main.activity_civil_sem4_old.*

class civil_sem4_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem4_old)
