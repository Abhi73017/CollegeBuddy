package com.abhishek.collegebuddy.OldSyllabus.ThirdSem
...
import kotlinx.android.synthetic.main.activity_civil_sem3_old.*

class civil_sem3_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem3_old)
