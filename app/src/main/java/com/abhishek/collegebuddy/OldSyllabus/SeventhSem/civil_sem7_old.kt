package com.abhishek.collegebuddy.OldSyllabus.SeventhSem
...
import kotlinx.android.synthetic.main.activity_civil_sem7_old.*

class civil_sem7_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem7_old)
