package com.abhishek.collegebuddy.OldSyllabus.SixthSem
...
import kotlinx.android.synthetic.main.activity_civil_sem6_old.*

class civil_sem6_old : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_civil_sem6_old)
